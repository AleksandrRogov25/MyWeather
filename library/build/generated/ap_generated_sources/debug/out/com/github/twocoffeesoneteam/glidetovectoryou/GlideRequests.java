...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.github.twocoffeesoneteam.glidetovectoryou.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.github.twocoffeesoneteam.glidetovectoryou.GlideOptions().apply(toSet));
    }
  }
}
